...
function moveFiles {
   ...
   mv /home/oracle/.bashrc $ORACLE_BASE/oradata/dbconfig/$ORACLE_SID/
...
function symLinkFiles {
   ...
   if [ ! -L /home/oracle/.bashrc ]; then
      ln -s $ORACLE_BASE/oradata/dbconfig/$ORACLE_SID/.bashrc /home/oracle/.bashrc
   fi;
